...
from model.avg_old import AvgPooling
...
class Experiment:
    def __init__(self, args, logger):
        ...
        self.logger = logger
        #Dict = Dictionary(args.data_path+'dict_'+args.task_type+args.partial_ratio+'.json')
        Dict = Dictionary(args.data_path+args.dataset+'/dict_'+args.task_type)
        self.dict = Dict.dict
